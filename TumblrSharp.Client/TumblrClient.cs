...
namespace DontPanic.TumblrSharp.Client
{
	...
	public class TumblrClient : TumblrClientBase
	{
		...
		/// </list>
		/// </exception>
		public Task<Posts> GetPostsAsync(string blogName, long startIndex = 0, int count = 20, PostType type = PostType.All, bool includeReblogInfo = false, bool includeNotesInfo = false, PostFilter filter = PostFilter.Html)
		{
			if (disposed)
				throw new ObjectDisposedException("TumblrClient");
